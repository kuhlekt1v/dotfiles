;; -_- mode: emacs-lisp; lexical-binding: t -_-
...
;; installs _all_ packages supported by Spacemacs and never uninstalls them.
...
;; in emacs 27.
;; (default (_ 1024 1024))
dotspacemacs-read-process-output-max (_ 1024 1024)
...
;; If non-nil, _scratch_ buffer will be persistent. Things you write down in
;; _scratch_ buffer will be saved and restored automatically.
dotspacemacs-scratch-buffer-persistent nil

;; If non-nil, `kill-buffer' on _scratch_ buffer
...
;; Don't create lock files or backups.
(setq create-lockfiles nil)
(setq make-backup-files nil)

(module/misc/smartparens)
(module/misc/prettier)
